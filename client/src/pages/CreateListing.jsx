    ...
    <main className='p-3 max-w-4xl mx-auto' >
        ...
        <div className='flex flex-col gap-4 flex-1' >
            ...
            <div className='flex flex-wrap gap-6' >
                ...
                <div className='flex items-center gap-2'>
                    <input type='number' id='bathroooms' min='1' max='10' required 
                    className='p-3 border border-gray-300 rounded-lg'/>
                    <p>Baths</p>
                </div>
                <div className='flex items-center gap-2'>
        ...
        <div className='flex flex-col flex-1'>
            ...
            <span className='font-normal text-gray-600 ml-2'>The first image will cover (max 6)</span>
            </p>
        ...
        <p className='text-red-700 text-sm'>{imageUploadError && imageUploadError}</p>
        {
            formData.imageUrls.length>0 && formData.imageUrls.map((url,index)=>(
                ...
                <img src={url} alt='listing imag' className='w-20 h-20 object-contain rounded-lg'/>
                <button type='button' onClick={()=> handleRemoveImage(index)} className='p-3 text-red-700 rounded-lg uppercase hover:opacity-75'>Delete</button>
                </div>
            ))
        }
        <button className='p-3 my-4 bg-slate-700 text-white rounded-lg uppercase
